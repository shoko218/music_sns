<template><!--投稿を表示-->
    <div class="replie_chain_posts">
        <div class="replie_chain_post" v-for="(post,idx) in dataPosts" :key="post['id']">
...
<script>
    import Vue from 'vue';
    import ShowRepliesChainComponent from './ShowPostsComponent'
